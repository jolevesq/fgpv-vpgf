    ...
    function exportService($mdDialog, $mdToast, storageService) {
        ...
        function ExportController($translate, $mdToast, $q, $filter, configService, appInfo,
            ...
            function wrapFootnote(text, width) {
                ...
                // set height fromt he number of line
             ...
             */
            function includeArrow() {
                const rotation = geoService.getNorthArrowAngle(); // TODO: gapiService.gapi.mapManager
            ...
            function saveImage() {
                ...
                drawMapShell().then(({ shellGraphic, mapOffset, legendOffset }) => {
                    ...
                    if (self.footnote) {
                        context.drawImage(self.footnoteGraphic, fullWidth / 2, mapHeight + 20);
                    }

                    if (self.isArrowIncluded) {
                        context.drawImage(self.arrowGraphic, fullWidth * 0.40, mapHeight + 30);
                    }

                    if (self.isScaleIncluded) {
                        context.drawImage(self.scaleGraphic, EXPORT_IMAGE_GUTTER, mapHeight + 20);
                    }
                ...
                function drawMapShell() {
                    ...
                    // get offset from info (scale, arrow and foornote)
                    const offsetInfo = Math.max.apply(null, self.infoHeight);
                    ...
                    const legendOffset = mapHeight + mapOffset + offsetInfo;
