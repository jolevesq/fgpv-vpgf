...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/chyf/index.ts");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/chyf/CHyFExtension.ts":
/*!***********************************!*\
  !*** ./src/chyf/CHyFExtension.ts ***!
  \***********************************/
/*! exports provided: CHyFExtension */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"CHyFExtension\", function() { return CHyFExtension; });\n/* harmony import */ var _manageExtension_Extension__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../manageExtension/Extension */ \"./src/manageExtension/Extension.ts\");\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_1__);\nvar __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {\n    return new (P || (P = Promise))(function (resolve, reject) {\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\n        function step(result) { result.done ? resolve(result.value) : new P(function (resolve) { resolve(result.value); }).then(fulfilled, rejected); }\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\n    });\n};\n//import { Map } from \"api/map\";\n\n\n/**\n * Hydraulic's extensions\n */\nclass CHyFExtension extends _manageExtension_Extension__WEBPACK_IMPORTED_MODULE_0__[\"Extension\"] {\n    constructor(name, url) {\n        super(name, url);\n    }\n    getJSON(point) {\n        return __awaiter(this, void 0, void 0, function* () {\n            try {\n                const response = yield axios__WEBPACK_IMPORTED_MODULE_1___default.a.get(`${this._url}?point=${point.x},${point.y}&removeHoles=false`);\n                return response.data;\n            }\n            catch (error) {\n                throw new Error(\"File not found\");\n            }\n        });\n    }\n    parse(json) {\n        let points = [];\n        let polygons = [];\n        try {\n            switch (json.geometry.type) {\n                case \"Polygon\":\n                    points.push(json.geometry.coordinates[0]);\n                    return new RZ.GEO.Polygon(1000, points, this.renderStyleGeometries);\n                case \"MultiPolygon\":\n                    json.geometry.coordinates.forEach((coordinates, index) => {\n                        points.push(coordinates[0]);\n                        polygons.push(new RZ.GEO.Polygon(1000 + index, points, this.renderStyleGeometries));\n                        points = [];\n                    });\n                    return new RZ.GEO.MultiPolygon(100000, polygons, this.renderStyleGeometries);\n            }\n        }\n        catch (error) {\n            throw new Error(`Cannot parse the data : ${error.message}`);\n        }\n    }\n    renderStyleGeometries() {\n        return {\n            outlineWidth: 0,\n            fillColor: '#000000',\n            fillOpacity: 0.3\n        };\n    }\n}\n\n\n//# sourceURL=webpack:///./src/chyf/CHyFExtension.ts?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _CHyFExtension__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./CHyFExtension */ \"./src/chyf/CHyFExtension.ts\");\n/* harmony import */ var _manageExtension_ExtensionsManager__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../manageExtension/ExtensionsManager */ \"./src/manageExtension/ExtensionsManager.ts\");\n\n\n/**\n * Global object called by the \"rz-extensions\".\n * The fonction \"init\" contain the global map instance \"api\"\n */\nwindow.myExtension = {\n    init: function (api) {\n        const manageExtension = new _manageExtension_ExtensionsManager__WEBPACK_IMPORTED_MODULE_1__[\"ExtensionsManager\"](api, \"CHyF\");\n        const upstream = new _CHyFExtension__WEBPACK_IMPORTED_MODULE_0__[\"CHyFExtension\"](\"upstream\", `http://dev.geogratis.gc.ca:8012/chyf/drainageArea/upstreamOf.json`);\n        const downstream = new _CHyFExtension__WEBPACK_IMPORTED_MODULE_0__[\"CHyFExtension\"](\"downstream\", `http://dev.geogratis.gc.ca:8012/chyf/drainageArea/downstreamOf.json`);\n        manageExtension.addExtensions([upstream, downstream]);\n    },\n    preInit: function (api) {\n        console.log('preint');\n    }\n};\n\n\n//# sourceURL=webpack:///./src/chyf/index.ts?");

/***/ }),

/***/ "./src/manageExtension/Extension.ts":
/*!******************************************!*\
  !*** ./src/manageExtension/Extension.ts ***!
  \******************************************/
